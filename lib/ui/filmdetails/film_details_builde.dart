...
class FilmDetailsBuilder extends StatefulWidget {
  ...
  FilmDetailsBuilder({super.key, required this.id});
...
class _FilmDetailsBuilderState extends State<FilmDetailsBuilder> {
  ...
  @override
  void initState() {
    filmDetailsViewModel.getFilm(widget.id);
  }
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          "-${(state.film.runtime)! ~/ 60}h ${state.film.runtime! % 60}m",
                          style: TextStyle(
                            color: Color(0xFFB5B4B4),
                            fontSize: 10,
                          ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "${state.film.voteAverage!.toStringAsFixed(2)}",
                                        style: TextStyle(
